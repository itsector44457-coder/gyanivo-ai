...
export function Sidebar({
  ...
  const links =
    role === "TRAINER" ? trainerLinks : role === "ADMIN" ? adminLinks : employeeLinks;
  ...
  const content = (
    <aside
      className={`flex h-full flex-col bg-[#0f1f3d] text-white transition-[width] duration-300 ease-in-out ${
