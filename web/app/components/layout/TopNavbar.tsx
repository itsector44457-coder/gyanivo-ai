...
export function TopNavbar({ onToggleMobileSidebar }: TopNavbarProps) {
  ...
  const displayRole =
    ...
    (user?.systemRole === "ADMIN"
      ? "Administrator"
      : user?.systemRole === "TRAINER"
      ? "Trainer"
      : "Statistical Officer");

  return (
    <>
      <header className="sticky top-0 z-30 flex h-14 w-full items-center justify-between border-b border-gray-200 bg-white px-4 sm:px-5">

        {/* left */}
        <div className="flex items-center gap-3">
          <button
            onClick={onToggleMobileSidebar}
            className="flex h-8 w-8 items-center justify-center rounded-lg text-gray-500 transition hover:bg-gray-100 lg:hidden"
        ...
        <div className="mx-4 hidden max-w-sm flex-1 md:flex">
          <div className="relative w-full">
            ...
            <input
              ...
              className="h-8 w-full rounded-lg border border-gray-200 bg-gray-50 pl-9 pr-3 text-[13px] text-gray-700 outline-none transition placeholder:text-gray-400 focus:border-blue-400 focus:bg-white focus:ring-2 focus:ring-blue-100"
            />
          </div>
        </div>
        ...
        <div className="flex items-center gap-1">
          ...
          <div className="relative">
            <button
              ...
              className="relative flex h-8 w-8 items-center justify-center rounded-lg text-gray-500 transition hover:bg-gray-100"
            ...
            {showNotifs && (
              <>
                ...
                <div className="absolute right-0 top-full z-50 mt-1.5 w-80 rounded-xl border border-gray-200 bg-white shadow-xl">
          ...
          <div className="relative">
            ...
            >
              ...
              <div className="hidden text-left xl:block">
                <p className="text-[12px] font-semibold leading-tight text-gray-900">{displayName}</p>
            ...
            {showProfile && (
              <>
                ...
                <div className="absolute right-0 top-full z-50 mt-1.5 w-52 rounded-xl border border-gray-200 bg-white py-1.5 shadow-xl">
                  <div className="border-b border-gray-100 px-3 pb-2.5 pt-1">
                    <p className="text-[12px] font-semibold text-gray-900">{displayName}</p>
                  ...
                  <div className="py-1">
                    <Link
                      ...
                      className="flex items-center gap-2.5 px-3 py-2 text-[12px] text-gray-700 transition hover:bg-gray-50"
                    >
                  ...
                  <div className="border-t border-gray-100 pt-1">
                    <button
                      ...
                      className="flex w-full items-center gap-2.5 px-3 py-2 text-[12px] text-red-500 transition hover:bg-red-50"
                    >
